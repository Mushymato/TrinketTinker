...
> [!TIP]
> It's not always obvious what frame is being shown, to help visualize things, enable [draw debug mode](007-Utility.md#tt.draw_debug) and get real time frame numbers.
