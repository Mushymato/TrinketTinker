...
| `ProcSound` | string | _null_ | Play a sound cue when ability procs ([details](https://stardewvalleywiki.com/Modding:Audio)). Besides just the string, you can specify a random list of pitch and/or a play chance: `{"CueName": "flute", "Pitch": [...], "Chance": 0.3}`. `Chance` is rolled fresh on every proc; defaults to 1 (always plays). |
