...
- **TinkerInventory**: An item is added to the [trinket's inventory](6-Inventory.md), if space allows. Otherwise the item either becomes debris or is not harvested (Forage).
