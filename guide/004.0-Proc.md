...
- **Interact**
    - When the player presses the [configured keybinding](009-User%20Configuration.md) while their bounding box overlaps with the companion's bounding box.
- **ActiveItemChange**
    - When the player's current item changes.
- **TinkerInventoryChange**
    - When the trinket's inventory acquires new items.
