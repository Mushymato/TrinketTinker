...
internal static class Places
{
    ...
    {
        if (
            crop.indexOfHarvest.Value != null
            && ItemRegistry.Create(crop.indexOfHarvest.Value
#if !SDV17
                , allowNull: false
#endif
            ) is Item item
    ...
    internal static Item? GetDebrisItem(Debris debris)
    {
        if (debris.item != null)
            return debris.item;
        if (debris.itemId.Value != null && (debris.debrisType.Value != 0 || debris.chunkType.Value != 8))
